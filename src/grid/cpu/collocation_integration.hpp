...
#ifndef COLLOCATION_INTEGRATION_HPP
#define COLLOCATION_INTEGRATION_HPP
#include <cstdio>
#include <cstdlib>
#include <cstring>
...
struct collocation_integration {
...
extern collocation_integration *collocate_create_handle();
