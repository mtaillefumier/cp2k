...
//******************************************************************************
void
grid_cpu_create_task_list(const int ntasks, const int nlevels, const int natoms, const int nkinds, const int nblocks,
                          ...
                          const int iatom_list[ntasks], const int jatom_list[ntasks], const int iset_list[ntasks],
                          ...
                          grid_cpu_task_list** task_list)
{
    ...
    grid_ref_create_task_list(ntasks, nlevels, natoms, nkinds, nblocks, buffer_size, block_offsets, atom_positions,
                              ...
                              blocks_buffer, &(*task_list)->crutch);
}
...
//******************************************************************************
void
grid_cpu_free_task_list(grid_cpu_task_list* task_list)
{
    //
    // TODO: Replace with actual cpu backend implementation.
    //
...
//******************************************************************************
void
grid_cpu_collocate_task_list(const grid_cpu_task_list* task_list, const bool orthorhombic, const int func,
                             ...
                             const double dh[nlevels][3][3], const double dh_inv[nlevels][3][3], double* grid[nlevels])
{
    ...
    // TODO: Replace with actual cpu backend implementation.
    //
    grid_ref_collocate_task_list(task_list->crutch, orthorhombic, func, nlevels, npts_global, npts_local, shift_local,
