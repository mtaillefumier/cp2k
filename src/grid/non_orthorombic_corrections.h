...
extern void calculate_non_orthorombic_corrections_tensor(const double mu_mean,
                                                         ...
                                                         bool plane[3],
                                                         tensor *const Exp);
extern void calculate_non_orthorombic_corrections_tensor_blocked(const double mu_mean,
                                                                 const double *r_ab,
                                                                 const double basis[3][3],
...
extern void apply_non_orthorombic_corrections_xz_yz_blocked(const struct tensor_ *const Exp_xz, const struct tensor_ *const Exp_yz, struct tensor_ *const m);
#endif
