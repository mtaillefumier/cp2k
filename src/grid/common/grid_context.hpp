...
public:
    ...
    int first_task(const int level) const {
        return first_task_[level];
    }
    ...
    double forces(int i, int j) const {
        return forces_(i, j);
    }
    ...
    double virial(int i, int j) const {
        return virial_(i, j);
    }
    ...
    int tasks_per_level(const int i) const {
        return tasks_per_level_[i];
    }

    const std::vector<task_info> &task_list() const {
        return tasks_list_;
    }
    ...
    bool calculate_tau() const {
        return calculate_tau_;
    }

    bool calculate_forces() const {
        return calculate_forces_;
    }

    bool calculate_virial() const {
