...
inline void
setup_global_grid_size(tensor* const grid, const int* const full_size)
{
    switch (grid->dim_) {
        case 1:
...
inline void
setup_grid_window(tensor* const grid, const int* const shift_local, const int* const border_width,
