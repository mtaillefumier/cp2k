...
// *****************************************************************************
static void
grid_prepare_pab_AB(const int o1, const int o2, const int la_max, const int la_min, const int lb_max, const int lb_min,
...
// *****************************************************************************
static void
grid_prepare_pab_DADB(const int o1, const int o2, const int la_max, const int la_min, const int lb_max,
...
// *****************************************************************************
static void
grid_prepare_pab_ADBmDAB(const int idir, const int o1, const int o2, const int la_max, const int la_min,
...
// *****************************************************************************
static void
grid_prepare_pab_ARDBmDARB(const int idir, const int ir, const int o1, const int o2, const int la_max, const int la_min,
                           const int lb_max, const int lb_min, const double zeta, const double zetb, const int n1,
                           const int n2, const double pab[n2][n1], const int n1_prep, const int n2_prep,
                           double pab_prep[n2_prep][n1_prep])
{
...
// *****************************************************************************
static void
grid_prepare_pab_DABpADB(const int idir, const int o1, const int o2, const int la_max, const int la_min,
                         const int lb_max, const int lb_min, const double zeta, const double zetb, const int n1,
                         const int n2, const double pab[n2][n1], const int n1_prep, const int n2_prep,
                         double pab_prep[n2_prep][n1_prep])
{
...
// *****************************************************************************
static void
grid_prepare_pab_Di(const int ider, const int o1, const int o2, const int la_max, const int la_min, const int lb_max,
                    const int lb_min, const double zeta, const double zetb, const int n1, const int n2,
                    const double pab[n2][n1], const int n1_prep, const int n2_prep, double pab_prep[n2_prep][n1_prep])
{
...
// *****************************************************************************
static void
grid_prepare_pab_DiDj(const int ider1, const int ider2, const int o1, const int o2, const int la_max, const int la_min,
                      const int lb_max, const int lb_min, const double zeta, const double zetb, const int n1,
                      const int n2, const double pab[n2][n1], const int n1_prep, const int n2_prep,
                      double pab_prep[n2_prep][n1_prep])
{
...
// *****************************************************************************
static void
grid_prepare_pab_Di2(const int ider, const int o1, const int o2, const int la_max, const int la_min, const int lb_max,
                     const int lb_min, const double zeta, const double zetb, const int n1, const int n2,
                     const double pab[n2][n1], const int n1_prep, const int n2_prep, double pab_prep[n2_prep][n1_prep])
{
...
// *****************************************************************************
void
grid_prepare_get_ldiffs(const int func, int* lmin_diff, int* lmax_diff)
{
    switch (func) {
        case GRID_FUNC_AB:
            lmax_diff[0] = 0;
...
// *****************************************************************************
void
grid_prepare_pab(const int func, const int o1, const int o2, const int* lmax, const int* lmin, const double zeta,
                 ...
                 const int n2_prep, double pab_prep[n2_prep][n1_prep])
{
    ...
    switch (func) {
        case GRID_FUNC_AB:
            grid_prepare_pab_AB(o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], n1, n2, pab, n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_DADB:
            grid_prepare_pab_DADB(o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                                  pab_prep);
            break;
        case GRID_FUNC_ADBmDAB_X:
            grid_prepare_pab_ADBmDAB(1, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                     n2_prep, pab_prep);
            break;
        case GRID_FUNC_ADBmDAB_Y:
            grid_prepare_pab_ADBmDAB(2, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                     n2_prep, pab_prep);
            break;
        case GRID_FUNC_ADBmDAB_Z:
            grid_prepare_pab_ADBmDAB(3, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                     n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_XX:
            grid_prepare_pab_ARDBmDARB(1, 1, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab,
                                       n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_XY:
            grid_prepare_pab_ARDBmDARB(1, 2, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab,
                                       n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_XZ:
            grid_prepare_pab_ARDBmDARB(1, 3, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab,
                                       n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_YX:
            grid_prepare_pab_ARDBmDARB(2, 1, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab,
                                       n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_YY:
            grid_prepare_pab_ARDBmDARB(2, 2, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab,
                                       n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_YZ:
            grid_prepare_pab_ARDBmDARB(2, 3, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab,
                                       n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_ZX:
            grid_prepare_pab_ARDBmDARB(3, 1, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab,
                                       n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_ZY:
            grid_prepare_pab_ARDBmDARB(3, 2, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab,
                                       n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_ZZ:
            grid_prepare_pab_ARDBmDARB(3, 3, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab,
                                       n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_DABpADB_X:
            grid_prepare_pab_DABpADB(1, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                     n2_prep, pab_prep);
            break;
        case GRID_FUNC_DABpADB_Y:
            grid_prepare_pab_DABpADB(2, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                     n2_prep, pab_prep);
            break;
        case GRID_FUNC_DABpADB_Z:
            grid_prepare_pab_DABpADB(3, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                     n2_prep, pab_prep);
            break;
        case GRID_FUNC_DX:
            grid_prepare_pab_Di(1, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                n2_prep, pab_prep);
            break;
        case GRID_FUNC_DY:
            grid_prepare_pab_Di(2, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                n2_prep, pab_prep);
            break;
        case GRID_FUNC_DZ:
            grid_prepare_pab_Di(3, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                n2_prep, pab_prep);
            break;
        case GRID_FUNC_DXDY:
            grid_prepare_pab_DiDj(1, 2, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_DYDZ:
            grid_prepare_pab_DiDj(2, 3, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_DZDX:
            grid_prepare_pab_DiDj(3, 1, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_DXDX:
            grid_prepare_pab_Di2(1, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                 n2_prep, pab_prep);
            break;
        case GRID_FUNC_DYDY:
            grid_prepare_pab_Di2(2, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                 n2_prep, pab_prep);
            break;
        case GRID_FUNC_DZDZ:
            grid_prepare_pab_Di2(3, o1, o2, lmax[0], lmin[0], lmax[1], lmin[1], zeta, zetb, n1, n2, pab, n1_prep,
                                 n2_prep, pab_prep);
            break;
        default:
            assert(false && "Unknown ga_gb_function.");
