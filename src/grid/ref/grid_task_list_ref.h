...
// \author Ole Schuett
//******************************************************************************
void grid_create_task_list_ref(const int ntasks, const int nlevels, const int natoms, const int nkinds,
                               ...
                               double** blocks_buffer, grid_task_list_private** task_list);

//******************************************************************************
// \brief Deallocates given task list, basis_sets have to be freed separately.
// \author Ole Schuett
//******************************************************************************
void grid_free_task_list_ref(grid_task_list_private* task_list);
...
// \author Ole Schuett
//******************************************************************************
void grid_collocate_task_list_ref(const grid_task_list_private* task_list, const bool orthorhombic, const int func,
