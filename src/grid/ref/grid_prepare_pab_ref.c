...
//******************************************************************************
static void
prepare_pab_AB(const int o1, const int o2, const int la_max, const int la_min, const int lb_max, const int lb_min,
               const int n1, const int n2, const double pab[n2][n1], const int n1_prep, const int n2_prep,
...
//******************************************************************************
static void
prepare_pab_DADB(const int o1, const int o2, const int la_max, const int la_min, const int lb_max, const int lb_min,
                 const double zeta, const double zetb, const int n1, const int n2, const double pab[n2][n1],
...
//******************************************************************************
static void
prepare_pab_ADBmDAB(const int idir, const int o1, const int o2, const int la_max, const int la_min, const int lb_max,
...
//******************************************************************************
static void
prepare_pab_ARDBmDARB(const int idir, const int ir, const int o1, const int o2, const int la_max, const int la_min,
...
//******************************************************************************
static void
prepare_pab_DABpADB(const int idir, const int o1, const int o2, const int la_max, const int la_min, const int lb_max,
                    const int lb_min, const double zeta, const double zetb, const int n1, const int n2,
                    const double pab[n2][n1], const int n1_prep, const int n2_prep, double pab_prep[n2_prep][n1_prep])
{
...
//******************************************************************************
static void
prepare_pab_Di(const int ider, const int o1, const int o2, const int la_max, const int la_min, const int lb_max,
               const int lb_min, const double zeta, const double zetb, const int n1, const int n2,
               const double pab[n2][n1], const int n1_prep, const int n2_prep, double pab_prep[n2_prep][n1_prep])
{
...
//******************************************************************************
static void
oneterm_dijdij(const int idir, const double func_a, const int ico_l, const int lx, const int ly, const int lz,
               const double zet, const int n1_prep, const int n2_prep, double pab_prep[n2_prep][n1_prep])
{
...
//******************************************************************************
static void
prepare_pab_DiDj(const int ider1, const int ider2, const int o1, const int o2, const int la_max, const int la_min,
                 const int lb_max, const int lb_min, const double zeta, const double zetb, const int n1, const int n2,
                 const double pab[n2][n1], const int n1_prep, const int n2_prep, double pab_prep[n2_prep][n1_prep])
{
...
//******************************************************************************
static void
oneterm_diidii(const int idir, const double func_a, const int ico_l, const int lx, const int ly, const int lz,
               const double zet, const int n1_prep, const int n2_prep, double pab_prep[n2_prep][n1_prep])
{
...
//******************************************************************************
static void
prepare_pab_Di2(const int ider, const int o1, const int o2, const int la_max, const int la_min, const int lb_max,
                const int lb_min, const double zeta, const double zetb, const int n1, const int n2,
                const double pab[n2][n1], const int n1_prep, const int n2_prep, double pab_prep[n2_prep][n1_prep])
{
...
//******************************************************************************
void
grid_ref_prepare_get_ldiffs(const int func, int* la_min_diff, int* la_max_diff, int* lb_min_diff, int* lb_max_diff)
{
    switch (func) {
        case GRID_FUNC_AB:
            *la_max_diff = 0;
                 ...
                 const double pab[n2][n1], const int n1_prep, const int n2_prep, double pab_prep[n2_prep][n1_prep])
{
    ...
    switch (func) {
        case GRID_FUNC_AB:
            prepare_pab_AB(o1, o2, la_max, la_min, lb_max, lb_min, n1, n2, pab, n1_prep, n2_prep, pab_prep);
            break;
        case GRID_FUNC_DADB:
            prepare_pab_DADB(o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                             pab_prep);
            break;
        case GRID_FUNC_ADBmDAB_X:
            prepare_pab_ADBmDAB(1, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                                pab_prep);
            break;
        case GRID_FUNC_ADBmDAB_Y:
            prepare_pab_ADBmDAB(2, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                                pab_prep);
            break;
        case GRID_FUNC_ADBmDAB_Z:
            prepare_pab_ADBmDAB(3, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                                pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_XX:
            prepare_pab_ARDBmDARB(1, 1, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_XY:
            prepare_pab_ARDBmDARB(1, 2, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_XZ:
            prepare_pab_ARDBmDARB(1, 3, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_YX:
            prepare_pab_ARDBmDARB(2, 1, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_YY:
            prepare_pab_ARDBmDARB(2, 2, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_YZ:
            prepare_pab_ARDBmDARB(2, 3, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_ZX:
            prepare_pab_ARDBmDARB(3, 1, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_ZY:
            prepare_pab_ARDBmDARB(3, 2, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_ARDBmDARB_ZZ:
            prepare_pab_ARDBmDARB(3, 3, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep,
                                  n2_prep, pab_prep);
            break;
        case GRID_FUNC_DABpADB_X:
            prepare_pab_DABpADB(1, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                                pab_prep);
            break;
        case GRID_FUNC_DABpADB_Y:
            prepare_pab_DABpADB(2, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                                pab_prep);
            break;
        case GRID_FUNC_DABpADB_Z:
            prepare_pab_DABpADB(3, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                                pab_prep);
            break;
        case GRID_FUNC_DX:
            prepare_pab_Di(1, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                           pab_prep);
            break;
        case GRID_FUNC_DY:
            prepare_pab_Di(2, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                           pab_prep);
            break;
        case GRID_FUNC_DZ:
            prepare_pab_Di(3, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                           pab_prep);
            break;
        case GRID_FUNC_DXDY:
            prepare_pab_DiDj(1, 2, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                             pab_prep);
            break;
        case GRID_FUNC_DYDZ:
            prepare_pab_DiDj(2, 3, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                             pab_prep);
            break;
        case GRID_FUNC_DZDX:
            prepare_pab_DiDj(3, 1, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                             pab_prep);
            break;
        case GRID_FUNC_DXDX:
            prepare_pab_Di2(1, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                            pab_prep);
            break;
        case GRID_FUNC_DYDY:
            prepare_pab_Di2(2, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                            pab_prep);
            break;
        case GRID_FUNC_DZDZ:
            prepare_pab_Di2(3, o1, o2, la_max, la_min, lb_max, lb_min, zeta, zetb, n1, n2, pab, n1_prep, n2_prep,
                            pab_prep);
            break;
        default:
            printf("Error: Unknown ga_gb_function.\n");
