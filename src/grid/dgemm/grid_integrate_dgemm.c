...
void extract_cube(struct collocation_integration_* handler, const int* lower_boundaries_cube, const int* cube_center)
{
    int position[3];
                ...
                if (upper_corner[1] - lower_corner[1]) {
                    ...
                    for (int x = 0; x < handler->cube.size[2]; x1++, x++) {
                        ...
                        if (upper_corner[2] - lower_corner[2]) {
                            ...
                            extract_sub_grid(lower_corner,    // lower corner of the portion of cube (in the full grid)
...
void
grid_integrate(collocation_integration* const handler, const bool use_ortho, const double zetp,
...
// *****************************************************************************
void
grid_integrate_pgf_product_dgemm(void* const handle, const bool use_ortho, const int lp, const double zeta,
                                 const double zetb, const double dh[3][3], const double dh_inv[3][3], const double ra[3],
                                 const double rab[3], const int grid_global_size[3], const int grid_local_size[3], const int shift_local[3],
