...
ENV SPEC="sirius@develop %gcc build_type=Release +enable_regtests +sirius +spla +libint2 smm=libxsmm +openmp +cosma +elpa +spglib +libvori +quip +pexsi +libxc +rocm ^openblas ^mpich ^spfft ^spla+rocm ^dbcsr+rocm ^cosma+rocm"
