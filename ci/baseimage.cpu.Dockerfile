...
ENV SPEC_OPENBLAS="cp2k@develop%gcc +libxc +libint smm=libxsmm +spglib +cosma +plumed +libvori +openmp ^openblas+fortran"
ENV SPEC_MKL="cp2k@develop%gcc +sirius +libxc +libint smm=libxsmm +spglib +cosma +plumed +libvori +mpi +openmp ^intel-oneapi-mkl+cluster"
